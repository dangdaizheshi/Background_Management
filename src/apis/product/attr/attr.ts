...
export const reqCategory2List = (category1Id: ns) => http.get<any, ResponseData>(API.C2_URL + category1Id)
export const reqCategory3List = (category2Id: ns) => http.get<any, ResponseData>(API.C3_URL + category2Id)
...
export const reqDeleteAttr = (attrId: number) => http.delete<any, any>(API.DELETE_ATTR_URL + attrId)